...
exports.parser = function (xmlcode, preserveStrings, ignoretags, debug) {
    ...
    exports.xmlobject = {};
    var y = exports.xml_to_object(x, preserveStrings).jsontagwrapper;
    if (debug) { y = exports.show_json_structure(y, debug) }    ;
    return y
}

exports.xml_to_object = function (xmlcode, preserveStrings) {
    ...
    for (var i = 0; i < y.length; i++) {
        ...
        if (rest != "" && (!onlywhites || nextNiva <= niva)) {
            ...
            else { rest = (preserveStrings && rest / 1 !== NaN) ? "'" + rest + "'" : rest; }
        } 
        //else { rest = (preserveStrings) ? "''" : "{}"; }        ;
        else { rest = "{}"; }        ;        
